...
function understrap_pagination() {
	...
	if ( ! in_array( 1, $links ) ) {
		...
		printf( '<li %s><a class="page-link" href="%s"><i class="fas fa-chevron-double-left"></i></i></a></li>' . "\n",
	...
	if ( ! in_array( $max, $links ) ) {
		...
		printf( '<li %s><a class="page-link" href="%s" aria-label="Next"><span aria-hidden="true"><i class="fas fa-chevron-double-right"></i></span><span class="sr-only">%s</span></a></li>' . "\n",
